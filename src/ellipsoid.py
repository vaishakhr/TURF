...
#    V: need to resolve how this computation is happening. what does this hyperplane refer to?
...
#     V: need to change estimate here
...
# need to change this function now
